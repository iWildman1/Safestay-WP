                                ...
                                if ( $query->have_posts() ) :
                                    ...
                                    while( $query->have_posts() ) : $query->the_post();
                                        if ($i == 0) {
                                            ...
                                            echo '
                                            <div class="grid-item ' . get_field('size_in_slider') . ' bg-spain-image flex centralize" style="background-image: url(' . get_the_post_thumbnail_url() . ')">
                                                <h3 class="underline-blue">' . get_the_title() . '</h3>
                                            </div>';
                                        }
                                        $i++;
                                    endwhile;
