<div class="container" data-country="United Kingdom">
        <div class="row">
            <div class="grid-item grid-30 bg-uk flex centralize">
                ...
                <div class="grid-item third bg-uk-image flex centralize" style="background-image: url('<?php bloginfo('stylesheet_directory') ?>/dist/img/411x364_Edinburgh.png')">
                    <h3 class="underline-blue">Edinburgh</h3>
                </div>
